        ...
        try:
            ...
            for pattern in self.sql_errors:
                ...
                if re.findall(pattern, response):
                    ...
                    formatted_text = f"[yellow bold]>>>  [/yellow bold] {url}  [red bold]{pattern}[/red bold]"
                    output_text = f"\x1b[1;33m>>> \x1b[0m {url}  \x1b[1;31m{pattern}\x1b[0m"
                    console.print(formatted_text)
                    with open('sqli_output.txt', 'a') as output_file:
